...
<div class="site-about">
    ...
    <p>
        Für diese Erkennungsfunktion wird ein Service der Internetseite <a href="<?= Url::to(['https://www.openalpr.com']) ?>">OpenALPR</a> genutzt. Wenn Sie mit den auf dieser Seite veröffentlichen Bedingungen nicht einverstanden sind, 
        dann dürfen Sie die automatische Erkennung der Kennzeichen nicht nutzen.
    </p>
    <p>
    ...
    <p>
        Daher werden alle Vorfälle, die vor mehr als ein Jahr in der Plattform dokumentiert wurden, öffentlich nur noch deutlich weniger detailliert und vor allem ohne großes Bild angezeigt. Nur der Eigner der Bilder kann diese weiterhin
    ...
    <p>
        Nach einem Jahr werden die großen und mittleren Formate der Bilder gelöscht, nach drei Jahren auch die kleinen und es bleiben dann nur noch die Thumbnails. Zudem wird nach drei Jahren ohne Änderungen
