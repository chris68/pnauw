...
<div class="citation-print">
    ...
    <?php endif; ?>
    <?=HtmlPurifier::process(Markdown::convert($printParameters->visibility=='unchanged'?$model->description:preg_replace('/`.*`/i','<span style="background-color:black;">          </span>',$model->description)))?> 
    ...
    <p><?=HtmlPurifier::process(Markdown::convert($printParameters->visibility=='unchanged'?$model->description:preg_replace('/`.*`/i','<span style="background-color:black;">          </span>',$model->description)))?></p>
    ...
    <?=HtmlPurifier::process(Markdown::convert($printParameters->visibility=='unchanged'?$model->history:preg_replace('/`.*`/i','<span style="background-color:black;">          </span>',$model->history)))?> 
    <?php endif ?>
</div>
