...
<div class="picture-print" style="page-break-after: always;">
    ...
    <h1>
        <?=Html::encode(($printParameters->visibility=='unchanged'?$model->vehicle_reg_plate:substr($model->vehicle_reg_plate,0,3).' ... '.substr($model->vehicle_reg_plate,-2)).' / '.date_format(date_create($model->taken),'d.m.Y').' / #'.$model->id)?>
