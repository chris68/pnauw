...
<div class="picture-print" style="page-break-after: always;">
    ...
    <h1>
        <?=Html::encode(($printParameters->visibility=='unchanged'?$model->vehicle_reg_plate:'{KFZ-Code:'.substr(hash('md5',$model->vehicle_reg_plate),0,8).'}').' / '.date_format(date_create($model->taken),'d.m.Y').' / #'.$model->id)?>
