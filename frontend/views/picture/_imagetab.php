...
<div class="row">
    ...
    <div class ="col-lg-3">
        <div>
            ...
            <?= $form->field($model,'citation_affix')->textarea(['rows' => 5, 'placeholder' => 'Hier können sie weitere Angaben für eine Meldung machen (Nicht öffentlich, sondern nur für den Empfänger der Meldung)']) ?>
        </div>
    </div>
