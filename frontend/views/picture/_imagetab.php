...
<div class="row">
    <div class="col-lg-3">
        ...
        <?= $form->field($model, 'citation_id')->dropDownList(frontend\models\Citation::dropDownList())->hint('Meldungen müssen Sie vorher anlegen') ?>
    ...
    <div class ="col-lg-3">
        <div>
            ...
            <?= $form->field($model,'citation_affix')->textarea(['rows' => 5, 'placeholder' => 'Hier können sie weitere Angaben für eine Meldung machen (Nicht öffentlich, sondern nur für den Empfänger der Meldung; für verschleierten Druck bitte in ` ` setzen))']) ?>
        </div>
    </div>
