                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="p[overviewlist]" id="p_l_show" value="show">
                            <label class="form-check-label" for="p_l_show">
                              Zeigen
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="p[overviewlist]" id="p_l_none" value="none" checked>
